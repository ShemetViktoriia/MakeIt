...
namespace MakeIt.BLL.IdentityConfig
{
        ...
        IUserLockoutStore<User, int>
    {
        ...
        public Task<IList<UserLoginInfo>> GetUserLoginsAsync(User user)
        {
            ...
            return System.Threading.Tasks.Task.FromResult<IList<UserLoginInfo>>(user.UserLogins.Select(l => new UserLoginInfo(l.LoginProvider, l.ProviderKey)).ToList());
        }
        ...
        public System.Threading.Tasks.Task AddClaimAsync(User user, Claim claim)
        {
            if (user == null)
            {
                throw new ArgumentNullException("user");
        ...
        public Task<IList<Claim>> GetUserClaimsAsync(User user)
        {
            ...
            return System.Threading.Tasks.Task.FromResult<IList<Claim>>(user.UserClaims.Select(c => new Claim(c.ClaimType, c.ClaimValue)).ToList());
        }

        public System.Threading.Tasks.Task RemoveClaimAsync(User user, Claim claim)
        {
            if (user == null)
            {
                throw new ArgumentNullException("user");
        ...
        public System.Threading.Tasks.Task AddToRoleAsync(User user, string roleName)
        {
            ...
            {
                throw new ArgumentException(MakeIt.EF.Resources.ValueCannotBeNullOrEmpty, "roleName");
            }
        ...
        public Task<IList<string>> GetRolesAsync(User user)
        {
            ...
            return System.Threading.Tasks.Task.FromResult<IList<string>>(user.Roles.Join(this.db.Roles, ur => ur.Id, r => r.Id, (ur, r) => r.Name).ToList());
        }
        ...
        public Task<bool> IsInRoleAsync(User user, string roleName)
        {
            ...
            return
                System.Threading.Tasks.Task.FromResult<bool>(
        ...
        public System.Threading.Tasks.Task SetPhoneNumberAsync(User user, string phoneNumber)
        {
            if (user == null)
            {
                throw new ArgumentNullException("user");
        ...
        public System.Threading.Tasks.Task SetPhoneNumberConfirmedAsync(User user, bool confirmed)
        {
            if (user == null)
            {
                throw new ArgumentNullException("user");
